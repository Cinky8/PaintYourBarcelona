          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-[rgba(227,226,224,0.1)] border border-white/5 rounded-2xl px-10 py-10 shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)]">
              <div className="flex flex-col gap-6">
                ...
                <div className="pt-4">
                  <button className="w-full bg-orange hover:bg-orange/90 text-[#541b00] font-sans font-bold text-base py-4 rounded-lg shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1)] transition-colors">
